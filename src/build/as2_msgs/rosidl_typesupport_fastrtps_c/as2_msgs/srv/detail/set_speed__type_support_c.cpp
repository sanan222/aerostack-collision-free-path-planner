...
#include "as2_msgs/srv/detail/set_speed__rosidl_typesupport_fastrtps_c.h"
...
#include "as2_msgs/msg/detail/speed__functions.h"  // speed

// forward declare type support functions
size_t get_serialized_size_as2_msgs__msg__Speed(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_as2_msgs__msg__Speed(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, as2_msgs, msg, Speed)();


using _SetSpeed_Request__ros_msg_type = as2_msgs__srv__SetSpeed_Request;
  ...
  // Field name: speed
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, as2_msgs, msg, Speed
      )()->data);
...
size_t get_serialized_size_as2_msgs__srv__SetSpeed_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetSpeed_Request__ros_msg_type * ros_message = static_cast<const _SetSpeed_Request__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_as2_msgs__msg__Speed(
...
static uint32_t _SetSpeed_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_as2_msgs__srv__SetSpeed_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_as2_msgs
size_t max_serialized_size_as2_msgs__srv__SetSpeed_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: speed
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_as2_msgs__msg__Speed(
  ...
  if (is_plain) {
    ...
    using DataType = as2_msgs__srv__SetSpeed_Request;
    is_plain =
      (
...
static size_t _SetSpeed_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_as2_msgs__srv__SetSpeed_Request(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, as2_msgs, srv, SetSpeed_Request)() {
...
using _SetSpeed_Response__ros_msg_type = as2_msgs__srv__SetSpeed_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_as2_msgs
size_t get_serialized_size_as2_msgs__srv__SetSpeed_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetSpeed_Response__ros_msg_type * ros_message = static_cast<const _SetSpeed_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_as2_msgs__srv__SetSpeed_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_as2_msgs
size_t max_serialized_size_as2_msgs__srv__SetSpeed_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = as2_msgs__srv__SetSpeed_Response;
    is_plain =
      (
...
static size_t _SetSpeed_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_as2_msgs__srv__SetSpeed_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, as2_msgs, srv, SetSpeed_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, as2_msgs, srv, SetSpeed)() {
