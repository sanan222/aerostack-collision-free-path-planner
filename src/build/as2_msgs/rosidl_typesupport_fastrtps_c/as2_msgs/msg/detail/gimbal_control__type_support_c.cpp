...
#include "as2_msgs/msg/detail/gimbal_control__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/vector3_stamped__functions.h"  // target
...
using _GimbalControl__ros_msg_type = as2_msgs__msg__GimbalControl;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _GimbalControl__ros_msg_type * ros_message = static_cast<const _GimbalControl__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _GimbalControl__ros_msg_type * ros_message = static_cast<_GimbalControl__ros_msg_type *>(untyped_ros_message);
  // Field name: control_mode
  {
    cdr >> ros_message->control_mode;
  }
...
static uint32_t _GimbalControl__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_as2_msgs__msg__GimbalControl(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = as2_msgs__msg__GimbalControl;
    is_plain =
      (
...
static size_t _GimbalControl__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_as2_msgs__msg__GimbalControl(
...
static message_type_support_callbacks_t __callbacks_GimbalControl = {
  "as2_msgs::msg",
  "GimbalControl",
...
static rosidl_message_type_support_t _GimbalControl__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_GimbalControl,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, as2_msgs, msg, GimbalControl)() {
  return &_GimbalControl__type_support;
}
