...
static const _PackageUnPick_Request_type_support_symbol_names_t _PackageUnPick_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, as2_msgs, srv, PackageUnPick_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, as2_msgs, srv, PackageUnPick_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, as2_msgs, srv, PackageUnPick_Request)() {
  return &::as2_msgs::srv::rosidl_typesupport_c::PackageUnPick_Request_message_type_support_handle;
}
...
static const _PackageUnPick_Response_type_support_symbol_names_t _PackageUnPick_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, as2_msgs, srv, PackageUnPick_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, as2_msgs, srv, PackageUnPick_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, as2_msgs, srv, PackageUnPick_Response)() {
  return &::as2_msgs::srv::rosidl_typesupport_c::PackageUnPick_Response_message_type_support_handle;
}
...
static const _PackageUnPick_type_support_symbol_names_t _PackageUnPick_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, as2_msgs, srv, PackageUnPick)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, as2_msgs, srv, PackageUnPick)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, as2_msgs, srv, PackageUnPick)() {
  return &::as2_msgs::srv::rosidl_typesupport_c::PackageUnPick_service_type_support_handle;
}
