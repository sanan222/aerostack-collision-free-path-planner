...
as2_msgs__srv__SetControlMode_Request__init(as2_msgs__srv__SetControlMode_Request * msg)
{
  ...
  // control_mode
  if (!as2_msgs__msg__ControlMode__init(&msg->control_mode)) {
    as2_msgs__srv__SetControlMode_Request__fini(msg);
    return false;
  }
  return true;
}
...
as2_msgs__srv__SetControlMode_Request__fini(as2_msgs__srv__SetControlMode_Request * msg)
{
  ...
  // control_mode
  as2_msgs__msg__ControlMode__fini(&msg->control_mode);
}
...
as2_msgs__srv__SetControlMode_Request__create()
{
  ...
  as2_msgs__srv__SetControlMode_Request * msg = (as2_msgs__srv__SetControlMode_Request *)allocator.allocate(sizeof(as2_msgs__srv__SetControlMode_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(as2_msgs__srv__SetControlMode_Request));
  bool success = as2_msgs__srv__SetControlMode_Request__init(msg);
  if (!success) {
...
as2_msgs__srv__SetControlMode_Request__Sequence__init(as2_msgs__srv__SetControlMode_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  as2_msgs__srv__SetControlMode_Request * data = NULL;

  if (size) {
    data = (as2_msgs__srv__SetControlMode_Request *)allocator.zero_allocate(size, sizeof(as2_msgs__srv__SetControlMode_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = as2_msgs__srv__SetControlMode_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        as2_msgs__srv__SetControlMode_Request__fini(&data[i - 1]);
      }
...
as2_msgs__srv__SetControlMode_Request__Sequence__fini(as2_msgs__srv__SetControlMode_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      as2_msgs__srv__SetControlMode_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  as2_msgs__srv__SetControlMode_Request__Sequence * array = (as2_msgs__srv__SetControlMode_Request__Sequence *)allocator.allocate(sizeof(as2_msgs__srv__SetControlMode_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = as2_msgs__srv__SetControlMode_Request__Sequence__init(array, size);
  if (!success) {
...
as2_msgs__srv__SetControlMode_Request__Sequence__destroy(as2_msgs__srv__SetControlMode_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    as2_msgs__srv__SetControlMode_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
as2_msgs__srv__SetControlMode_Request__Sequence__are_equal(const as2_msgs__srv__SetControlMode_Request__Sequence * lhs, const as2_msgs__srv__SetControlMode_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!as2_msgs__srv__SetControlMode_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  as2_msgs__srv__SetControlMode_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(as2_msgs__srv__SetControlMode_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    as2_msgs__srv__SetControlMode_Request * data =
      (as2_msgs__srv__SetControlMode_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!as2_msgs__srv__SetControlMode_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          as2_msgs__srv__SetControlMode_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!as2_msgs__srv__SetControlMode_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  as2_msgs__srv__SetControlMode_Response * msg = (as2_msgs__srv__SetControlMode_Response *)allocator.allocate(sizeof(as2_msgs__srv__SetControlMode_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(as2_msgs__srv__SetControlMode_Response));
  bool success = as2_msgs__srv__SetControlMode_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
as2_msgs__srv__SetControlMode_Response__destroy(as2_msgs__srv__SetControlMode_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    as2_msgs__srv__SetControlMode_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
as2_msgs__srv__SetControlMode_Response__Sequence__init(as2_msgs__srv__SetControlMode_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  as2_msgs__srv__SetControlMode_Response * data = NULL;

  if (size) {
    data = (as2_msgs__srv__SetControlMode_Response *)allocator.zero_allocate(size, sizeof(as2_msgs__srv__SetControlMode_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = as2_msgs__srv__SetControlMode_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        as2_msgs__srv__SetControlMode_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
as2_msgs__srv__SetControlMode_Response__Sequence__fini(as2_msgs__srv__SetControlMode_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      as2_msgs__srv__SetControlMode_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  as2_msgs__srv__SetControlMode_Response__Sequence * array = (as2_msgs__srv__SetControlMode_Response__Sequence *)allocator.allocate(sizeof(as2_msgs__srv__SetControlMode_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = as2_msgs__srv__SetControlMode_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
as2_msgs__srv__SetControlMode_Response__Sequence__destroy(as2_msgs__srv__SetControlMode_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    as2_msgs__srv__SetControlMode_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
as2_msgs__srv__SetControlMode_Response__Sequence__are_equal(const as2_msgs__srv__SetControlMode_Response__Sequence * lhs, const as2_msgs__srv__SetControlMode_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!as2_msgs__srv__SetControlMode_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  as2_msgs__srv__SetControlMode_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(as2_msgs__srv__SetControlMode_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    as2_msgs__srv__SetControlMode_Response * data =
      (as2_msgs__srv__SetControlMode_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!as2_msgs__srv__SetControlMode_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          as2_msgs__srv__SetControlMode_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!as2_msgs__srv__SetControlMode_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
