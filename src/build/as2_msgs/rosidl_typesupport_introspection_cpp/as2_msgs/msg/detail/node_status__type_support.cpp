...
{
  new (message_memory) as2_msgs::msg::NodeStatus(_init);
}

void NodeStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<as2_msgs::msg::NodeStatus *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember NodeStatus_message_member_array[1] = {
  {
    ...
    offsetof(as2_msgs::msg::NodeStatus, status),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers NodeStatus_message_members = {
  ...
  1,  // number of fields
  sizeof(as2_msgs::msg::NodeStatus),
...
{
  return &::as2_msgs::msg::rosidl_typesupport_introspection_cpp::NodeStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, as2_msgs, msg, NodeStatus)() {
  return &::as2_msgs::msg::rosidl_typesupport_introspection_cpp::NodeStatus_message_type_support_handle;
}
