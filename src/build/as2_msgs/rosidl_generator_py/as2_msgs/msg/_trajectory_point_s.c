...
bool as2_msgs__msg__trajectory_point__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("as2_msgs.msg._trajectory_point.TrajectoryPoint", full_classname_dest, 46) == 0);
  }
  as2_msgs__msg__TrajectoryPoint * ros_message = _ros_message;
  {  // position
  ...
  {  // twist
    ...
    if (!geometry_msgs__msg__vector3__convert_from_py(field, &ros_message->twist)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * as2_msgs__msg__trajectory_point__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("as2_msgs.msg._trajectory_point");
  ...
  {  // twist
    PyObject * field = NULL;
    field = geometry_msgs__msg__vector3__convert_to_py(&ros_message->twist);
    if (!field) {
      return NULL;
    }
    {
