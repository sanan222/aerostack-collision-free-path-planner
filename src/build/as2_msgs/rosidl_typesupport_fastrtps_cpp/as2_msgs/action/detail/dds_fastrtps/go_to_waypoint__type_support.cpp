...
#include "as2_msgs/action/detail/go_to_waypoint__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const as2_msgs::action::GoToWaypoint_Goal & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  as2_msgs::action::GoToWaypoint_Goal & ros_message)
{
  // Member: yaw
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = as2_msgs::action::GoToWaypoint_Goal;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const as2_msgs::action::GoToWaypoint_Goal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<as2_msgs::action::GoToWaypoint_Goal *>(
    untyped_ros_message);
...
{
  return &as2_msgs::action::typesupport_fastrtps_cpp::_GoToWaypoint_Goal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, as2_msgs, action, GoToWaypoint_Goal)() {
  return &as2_msgs::action::typesupport_fastrtps_cpp::_GoToWaypoint_Goal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_as2_msgs
cdr_serialize(
  const as2_msgs::action::GoToWaypoint_Result & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  as2_msgs::action::GoToWaypoint_Result & ros_message)
{
  // Member: go_to_success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = as2_msgs::action::GoToWaypoint_Result;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const as2_msgs::action::GoToWaypoint_Result *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<as2_msgs::action::GoToWaypoint_Result *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &as2_msgs::action::typesupport_fastrtps_cpp::_GoToWaypoint_Result__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, as2_msgs, action, GoToWaypoint_Result)() {
  return &as2_msgs::action::typesupport_fastrtps_cpp::_GoToWaypoint_Result__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_as2_msgs
cdr_serialize(
  const as2_msgs::action::GoToWaypoint_Feedback & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: actual_speed
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  as2_msgs::action::GoToWaypoint_Feedback & ros_message)
{
  // Member: actual_speed
  cdr >> ros_message.actual_speed;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = as2_msgs::action::GoToWaypoint_Feedback;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const as2_msgs::action::GoToWaypoint_Feedback *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<as2_msgs::action::GoToWaypoint_Feedback *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &as2_msgs::action::typesupport_fastrtps_cpp::_GoToWaypoint_Feedback__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, as2_msgs, action, GoToWaypoint_Feedback)() {
  return &as2_msgs::action::typesupport_fastrtps_cpp::_GoToWaypoint_Feedback__handle;
}
...
// functions for as2_msgs::action::GoToWaypoint_Goal already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_as2_msgs
cdr_serialize(
  const as2_msgs::action::GoToWaypoint_SendGoal_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  as2_msgs::action::GoToWaypoint_SendGoal_Request & ros_message)
{
  // Member: goal_id
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        as2_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_GoToWaypoint_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = as2_msgs::action::GoToWaypoint_SendGoal_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const as2_msgs::action::GoToWaypoint_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<as2_msgs::action::GoToWaypoint_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &as2_msgs::action::typesupport_fastrtps_cpp::_GoToWaypoint_SendGoal_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, as2_msgs, action, GoToWaypoint_SendGoal_Request)() {
  return &as2_msgs::action::typesupport_fastrtps_cpp::_GoToWaypoint_SendGoal_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_as2_msgs
cdr_serialize(
  const as2_msgs::action::GoToWaypoint_SendGoal_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: accepted
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  as2_msgs::action::GoToWaypoint_SendGoal_Response & ros_message)
{
  // Member: accepted
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = as2_msgs::action::GoToWaypoint_SendGoal_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const as2_msgs::action::GoToWaypoint_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<as2_msgs::action::GoToWaypoint_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &as2_msgs::action::typesupport_fastrtps_cpp::_GoToWaypoint_SendGoal_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, as2_msgs, action, GoToWaypoint_SendGoal_Response)() {
  return &as2_msgs::action::typesupport_fastrtps_cpp::_GoToWaypoint_SendGoal_Response__handle;
}
...
{
  return &as2_msgs::action::typesupport_fastrtps_cpp::_GoToWaypoint_SendGoal__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, as2_msgs, action, GoToWaypoint_SendGoal)() {
  return &as2_msgs::action::typesupport_fastrtps_cpp::_GoToWaypoint_SendGoal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_as2_msgs
cdr_serialize(
  const as2_msgs::action::GoToWaypoint_GetResult_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  as2_msgs::action::GoToWaypoint_GetResult_Request & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = as2_msgs::action::GoToWaypoint_GetResult_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const as2_msgs::action::GoToWaypoint_GetResult_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<as2_msgs::action::GoToWaypoint_GetResult_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &as2_msgs::action::typesupport_fastrtps_cpp::_GoToWaypoint_GetResult_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, as2_msgs, action, GoToWaypoint_GetResult_Request)() {
  return &as2_msgs::action::typesupport_fastrtps_cpp::_GoToWaypoint_GetResult_Request__handle;
}
...
// forward declaration of message dependencies and their conversion functions
// functions for as2_msgs::action::GoToWaypoint_Result already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_as2_msgs
cdr_serialize(
  const as2_msgs::action::GoToWaypoint_GetResult_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: status
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  as2_msgs::action::GoToWaypoint_GetResult_Response & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  // Member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        as2_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_GoToWaypoint_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = as2_msgs::action::GoToWaypoint_GetResult_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const as2_msgs::action::GoToWaypoint_GetResult_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<as2_msgs::action::GoToWaypoint_GetResult_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &as2_msgs::action::typesupport_fastrtps_cpp::_GoToWaypoint_GetResult_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, as2_msgs, action, GoToWaypoint_GetResult_Response)() {
  return &as2_msgs::action::typesupport_fastrtps_cpp::_GoToWaypoint_GetResult_Response__handle;
}
...
{
  return &as2_msgs::action::typesupport_fastrtps_cpp::_GoToWaypoint_GetResult__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, as2_msgs, action, GoToWaypoint_GetResult)() {
  return &as2_msgs::action::typesupport_fastrtps_cpp::_GoToWaypoint_GetResult__handle;
}
...
// functions for as2_msgs::action::GoToWaypoint_Feedback already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_as2_msgs
cdr_serialize(
  const as2_msgs::action::GoToWaypoint_FeedbackMessage & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  as2_msgs::action::GoToWaypoint_FeedbackMessage & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  // Member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        as2_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_GoToWaypoint_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = as2_msgs::action::GoToWaypoint_FeedbackMessage;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const as2_msgs::action::GoToWaypoint_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<as2_msgs::action::GoToWaypoint_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &as2_msgs::action::typesupport_fastrtps_cpp::_GoToWaypoint_FeedbackMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, as2_msgs, action, GoToWaypoint_FeedbackMessage)() {
  return &as2_msgs::action::typesupport_fastrtps_cpp::_GoToWaypoint_FeedbackMessage__handle;
}
