...
#include "as2_msgs/msg/detail/speed__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const as2_msgs::msg::Speed & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  as2_msgs::msg::Speed & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = as2_msgs::msg::Speed;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const as2_msgs::msg::Speed *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<as2_msgs::msg::Speed *>(
    untyped_ros_message);
...
{
  return &as2_msgs::msg::typesupport_fastrtps_cpp::_Speed__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, as2_msgs, msg, Speed)() {
  return &as2_msgs::msg::typesupport_fastrtps_cpp::_Speed__handle;
}
