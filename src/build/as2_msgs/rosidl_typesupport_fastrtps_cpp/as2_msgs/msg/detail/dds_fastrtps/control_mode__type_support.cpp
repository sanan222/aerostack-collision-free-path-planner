...
#include "as2_msgs/msg/detail/control_mode__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const as2_msgs::msg::ControlMode & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  as2_msgs::msg::ControlMode & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = as2_msgs::msg::ControlMode;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const as2_msgs::msg::ControlMode *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<as2_msgs::msg::ControlMode *>(
    untyped_ros_message);
...
{
  return &as2_msgs::msg::typesupport_fastrtps_cpp::_ControlMode__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, as2_msgs, msg, ControlMode)() {
  return &as2_msgs::msg::typesupport_fastrtps_cpp::_ControlMode__handle;
}
