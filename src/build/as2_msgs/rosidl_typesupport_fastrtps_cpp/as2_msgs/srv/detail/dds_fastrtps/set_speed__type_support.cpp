...
#include "as2_msgs/srv/detail/set_speed__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const as2_msgs::srv::SetSpeed_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  as2_msgs::srv::SetSpeed_Request & ros_message)
{
  // Member: speed
  ...
  size_t current_alignment)
{
  ...
  // Member: speed
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        as2_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Speed(
  ...
  if (is_plain) {
    ...
    using DataType = as2_msgs::srv::SetSpeed_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const as2_msgs::srv::SetSpeed_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<as2_msgs::srv::SetSpeed_Request *>(
    untyped_ros_message);
...
{
  return &as2_msgs::srv::typesupport_fastrtps_cpp::_SetSpeed_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, as2_msgs, srv, SetSpeed_Request)() {
  return &as2_msgs::srv::typesupport_fastrtps_cpp::_SetSpeed_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_as2_msgs
cdr_serialize(
  const as2_msgs::srv::SetSpeed_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  as2_msgs::srv::SetSpeed_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = as2_msgs::srv::SetSpeed_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const as2_msgs::srv::SetSpeed_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<as2_msgs::srv::SetSpeed_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &as2_msgs::srv::typesupport_fastrtps_cpp::_SetSpeed_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, as2_msgs, srv, SetSpeed_Response)() {
  return &as2_msgs::srv::typesupport_fastrtps_cpp::_SetSpeed_Response__handle;
}
...
{
  return &as2_msgs::srv::typesupport_fastrtps_cpp::_SetSpeed__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, as2_msgs, srv, SetSpeed)() {
  return &as2_msgs::srv::typesupport_fastrtps_cpp::_SetSpeed__handle;
}
