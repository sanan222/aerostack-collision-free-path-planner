...
execute_process(
  COMMAND "/usr/bin/git" show-ref "v2.0"
  WORKING_DIRECTORY "/mission_planning_ws/src/build/as2_platform_multirotor_simulator/_deps/multirotor_simulator-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("v2.0" tag_sha error_msg)
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/mission_planning_ws/src/build/as2_platform_multirotor_simulator/_deps/multirotor_simulator-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/mission_planning_ws/src/build/as2_platform_multirotor_simulator/_deps/multirotor_simulator-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
