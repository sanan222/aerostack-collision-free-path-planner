...
: ${AMENT_CURRENT_PREFIX:="/mission_planning_ws/src/install/aerostack2"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/aerostack2/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/aerostack2/environment/path.sh"
