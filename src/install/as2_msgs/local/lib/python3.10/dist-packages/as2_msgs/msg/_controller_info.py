...
class ControllerInfo(metaclass=Metaclass_ControllerInfo):
    ...
    __slots__ = [
        '_header',
        '_input_control_mode',
        '_output_control_mode',
    ]

    _fields_and_field_types = {
        'header': 'std_msgs/Header',
        'input_control_mode': 'as2_msgs/ControlMode',
        'output_control_mode': 'as2_msgs/ControlMode',
    }
    ...
    def __init__(self, **kwargs):
        ...
        from as2_msgs.msg import ControlMode
        self.input_control_mode = kwargs.get('input_control_mode', ControlMode())
        from as2_msgs.msg import ControlMode
        self.output_control_mode = kwargs.get('output_control_mode', ControlMode())
    ...
    def __eq__(self, other):
        ...
        if self.header != other.header:
            return False
        if self.input_control_mode != other.input_control_mode:
            return False
        if self.output_control_mode != other.output_control_mode:
            return False
        return True
    ...
    def input_control_mode(self):
        """Message field 'input_control_mode'."""
        return self._input_control_mode

    @input_control_mode.setter
    def input_control_mode(self, value):
        if __debug__:
            from as2_msgs.msg import ControlMode
            assert \
                isinstance(value, ControlMode), \
                "The 'input_control_mode' field must be a sub message of type 'ControlMode'"
        self._input_control_mode = value

    @builtins.property
    def output_control_mode(self):
        """Message field 'output_control_mode'."""
        return self._output_control_mode

    @output_control_mode.setter
    def output_control_mode(self, value):
        if __debug__:
            from as2_msgs.msg import ControlMode
            assert \
                isinstance(value, ControlMode), \
                "The 'output_control_mode' field must be a sub message of type 'ControlMode'"
        self._output_control_mode = value
