...
#ifndef AS2_MSGS__SRV__DETAIL__DYNAMIC_FOLLOWER__TYPE_SUPPORT_H_
#define AS2_MSGS__SRV__DETAIL__DYNAMIC_FOLLOWER__TYPE_SUPPORT_H_
...
#endif  // AS2_MSGS__SRV__DETAIL__DYNAMIC_FOLLOWER__TYPE_SUPPORT_H_
