...
: ${AMENT_CURRENT_PREFIX:="/mission_planning_ws/src/install/as2_behaviors_perception"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/as2_behaviors_perception/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/as2_behaviors_perception/environment/path.sh"
