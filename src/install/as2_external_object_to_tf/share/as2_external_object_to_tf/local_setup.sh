...
: ${AMENT_CURRENT_PREFIX:="/mission_planning_ws/src/install/as2_external_object_to_tf"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/as2_external_object_to_tf/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/as2_external_object_to_tf/environment/path.sh"
