...
{
  new (message_memory) as2_msgs::msg::ControllerInfo(_init);
}

void ControllerInfo_fini_function(void * message_memory)
{
  auto typed_message = static_cast<as2_msgs::msg::ControllerInfo *>(message_memory);
  typed_message->~ControllerInfo();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember ControllerInfo_message_member_array[3] = {
  {
    "header",  // name
    ...
    offsetof(as2_msgs::msg::ControllerInfo, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(as2_msgs::msg::ControllerInfo, input_control_mode),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(as2_msgs::msg::ControllerInfo, output_control_mode),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ControllerInfo_message_members = {
  ...
  3,  // number of fields
  sizeof(as2_msgs::msg::ControllerInfo),
...
{
  return &::as2_msgs::msg::rosidl_typesupport_introspection_cpp::ControllerInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, as2_msgs, msg, ControllerInfo)() {
  return &::as2_msgs::msg::rosidl_typesupport_introspection_cpp::ControllerInfo_message_type_support_handle;
}
