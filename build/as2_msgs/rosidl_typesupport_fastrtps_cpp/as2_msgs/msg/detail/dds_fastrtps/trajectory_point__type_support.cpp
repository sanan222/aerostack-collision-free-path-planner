...
#include "as2_msgs/msg/detail/trajectory_point__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const as2_msgs::msg::TrajectoryPoint & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  as2_msgs::msg::TrajectoryPoint & ros_message)
{
  // Member: position
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = as2_msgs::msg::TrajectoryPoint;
    is_plain =
      (
      offsetof(DataType, yaw_angle) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const as2_msgs::msg::TrajectoryPoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<as2_msgs::msg::TrajectoryPoint *>(
    untyped_ros_message);
...
{
  return &as2_msgs::msg::typesupport_fastrtps_cpp::_TrajectoryPoint__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, as2_msgs, msg, TrajectoryPoint)() {
  return &as2_msgs::msg::typesupport_fastrtps_cpp::_TrajectoryPoint__handle;
}
