...
static const _SetControlMode_Request_type_support_symbol_names_t _SetControlMode_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, as2_msgs, srv, SetControlMode_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, as2_msgs, srv, SetControlMode_Request)),
  }
};
...
{
  return &::as2_msgs::srv::rosidl_typesupport_cpp::SetControlMode_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, as2_msgs, srv, SetControlMode_Request)() {
  return get_message_type_support_handle<as2_msgs::srv::SetControlMode_Request>();
}
...
static const _SetControlMode_Response_type_support_symbol_names_t _SetControlMode_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, as2_msgs, srv, SetControlMode_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, as2_msgs, srv, SetControlMode_Response)),
  }
};
...
{
  return &::as2_msgs::srv::rosidl_typesupport_cpp::SetControlMode_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, as2_msgs, srv, SetControlMode_Response)() {
  return get_message_type_support_handle<as2_msgs::srv::SetControlMode_Response>();
}
...
static const _SetControlMode_type_support_symbol_names_t _SetControlMode_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, as2_msgs, srv, SetControlMode)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, as2_msgs, srv, SetControlMode)),
  }
};
...
{
  return &::as2_msgs::srv::rosidl_typesupport_cpp::SetControlMode_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, as2_msgs, srv, SetControlMode)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<as2_msgs::srv::SetControlMode>();
}
