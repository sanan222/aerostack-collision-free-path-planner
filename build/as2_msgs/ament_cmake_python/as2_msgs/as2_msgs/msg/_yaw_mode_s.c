...
bool as2_msgs__msg__yaw_mode__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("as2_msgs.msg._yaw_mode.YawMode", full_classname_dest, 30) == 0);
  }
  as2_msgs__msg__YawMode * ros_message = _ros_message;
  {  // mode
...
{
  /* NOTE(esteve): Call constructor of YawMode */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("as2_msgs.msg._yaw_mode");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "YawMode");
