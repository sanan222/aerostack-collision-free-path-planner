...
class Metaclass_SetSpeed_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from as2_msgs.msg import Speed
...
class SetSpeed_Request(metaclass=Metaclass_SetSpeed_Request):
    ...
    _fields_and_field_types = {
        'speed': 'as2_msgs/Speed',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['as2_msgs', 'msg'], 'Speed'),  # noqa: E501
    )
...
class Metaclass_SetSpeed(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from as2_msgs.srv import _set_speed
...
class SetSpeed(metaclass=Metaclass_SetSpeed):
    from as2_msgs.srv._set_speed import SetSpeed_Request as Request
    from as2_msgs.srv._set_speed import SetSpeed_Response as Response
