...
bool as2_msgs__msg__pose_with_id__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("as2_msgs.msg._pose_with_id.PoseWithID", full_classname_dest, 37) == 0);
  }
  as2_msgs__msg__PoseWithID * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of PoseWithID */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("as2_msgs.msg._pose_with_id");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PoseWithID");
