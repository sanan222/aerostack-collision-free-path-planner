...
class Metaclass_NodeStatus(type):
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            'UNCONFIGURED': cls.__constants['UNCONFIGURED'],
    ...
    def UNCONFIGURED(self):
        """Message constant 'UNCONFIGURED'."""
        return Metaclass_NodeStatus.__constants['UNCONFIGURED']

    @property
    def INACTIVE(self):
        """Message constant 'INACTIVE'."""
        return Metaclass_NodeStatus.__constants['INACTIVE']

    @property
    def ACTIVE(self):
        """Message constant 'ACTIVE'."""
        return Metaclass_NodeStatus.__constants['ACTIVE']

    @property
    def FINALIZED(self):
        """Message constant 'FINALIZED'."""
        return Metaclass_NodeStatus.__constants['FINALIZED']
