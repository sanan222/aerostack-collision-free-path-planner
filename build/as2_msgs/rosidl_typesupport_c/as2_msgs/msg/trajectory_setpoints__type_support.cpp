...
static const _TrajectorySetpoints_type_support_symbol_names_t _TrajectorySetpoints_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, as2_msgs, msg, TrajectorySetpoints)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, as2_msgs, msg, TrajectorySetpoints)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, as2_msgs, msg, TrajectorySetpoints)() {
  return &::as2_msgs::msg::rosidl_typesupport_c::TrajectorySetpoints_message_type_support_handle;
}
