...
static const _PlatformStateMachineEvent_type_support_symbol_names_t _PlatformStateMachineEvent_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, as2_msgs, msg, PlatformStateMachineEvent)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, as2_msgs, msg, PlatformStateMachineEvent)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, as2_msgs, msg, PlatformStateMachineEvent)() {
  return &::as2_msgs::msg::rosidl_typesupport_c::PlatformStateMachineEvent_message_type_support_handle;
}
