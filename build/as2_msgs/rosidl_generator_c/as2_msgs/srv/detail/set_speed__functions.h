...
#ifndef AS2_MSGS__SRV__DETAIL__SET_SPEED__FUNCTIONS_H_
#define AS2_MSGS__SRV__DETAIL__SET_SPEED__FUNCTIONS_H_
 ...
 * calls
 * as2_msgs__srv__SetSpeed_Request__init().
...
/**
 * It calls
 * as2_msgs__srv__SetSpeed_Request__fini()
 ...
 * as2_msgs__srv__SetSpeed_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * as2_msgs__srv__SetSpeed_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * as2_msgs__srv__SetSpeed_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_as2_msgs
...
/**
 * It calls
 * as2_msgs__srv__SetSpeed_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_as2_msgs
...
/**
 * It allocates the memory for the array and calls
 * as2_msgs__srv__SetSpeed_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_as2_msgs
...
/**
 * It calls
 * as2_msgs__srv__SetSpeed_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // AS2_MSGS__SRV__DETAIL__SET_SPEED__FUNCTIONS_H_
