...
#include "as2_msgs/msg/detail/thrust__rosidl_typesupport_fastrtps_c.h"
...
using _Thrust__ros_msg_type = as2_msgs__msg__Thrust;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: thrust_normalized
  {
    cdr << ros_message->thrust_normalized;
  }
...
size_t get_serialized_size_as2_msgs__msg__Thrust(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Thrust__ros_msg_type * ros_message = static_cast<const _Thrust__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name thrust_normalized
  {
    size_t item_size = sizeof(ros_message->thrust_normalized);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
static uint32_t _Thrust__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_as2_msgs__msg__Thrust(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_as2_msgs
size_t max_serialized_size_as2_msgs__msg__Thrust(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = as2_msgs__msg__Thrust;
    is_plain =
      (
      offsetof(DataType, thrust_normalized) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _Thrust__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_as2_msgs__msg__Thrust(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, as2_msgs, msg, Thrust)() {
