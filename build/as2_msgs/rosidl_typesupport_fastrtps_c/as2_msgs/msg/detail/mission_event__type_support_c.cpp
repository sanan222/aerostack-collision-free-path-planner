...
#include "as2_msgs/msg/detail/mission_event__rosidl_typesupport_fastrtps_c.h"
...
using _MissionEvent__ros_msg_type = as2_msgs__msg__MissionEvent;
...
size_t get_serialized_size_as2_msgs__msg__MissionEvent(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MissionEvent__ros_msg_type * ros_message = static_cast<const _MissionEvent__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _MissionEvent__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_as2_msgs__msg__MissionEvent(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_as2_msgs
size_t max_serialized_size_as2_msgs__msg__MissionEvent(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = as2_msgs__msg__MissionEvent;
    is_plain =
      (
...
static size_t _MissionEvent__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_as2_msgs__msg__MissionEvent(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, as2_msgs, msg, MissionEvent)() {
