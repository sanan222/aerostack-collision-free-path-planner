...
#include "as2_msgs/msg/detail/controller_info__rosidl_typesupport_fastrtps_c.h"
...
#include "as2_msgs/msg/detail/control_mode__functions.h"  // input_control_mode, output_control_mode
...
using _ControllerInfo__ros_msg_type = as2_msgs__msg__ControllerInfo;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: input_control_mode
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->input_control_mode, cdr))
    {
      return false;
    }
  }

  // Field name: output_control_mode
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->output_control_mode, cdr))
    {
      return false;
    }
  }
...
size_t get_serialized_size_as2_msgs__msg__ControllerInfo(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ControllerInfo__ros_msg_type * ros_message = static_cast<const _ControllerInfo__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _ControllerInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_as2_msgs__msg__ControllerInfo(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_as2_msgs
size_t max_serialized_size_as2_msgs__msg__ControllerInfo(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = as2_msgs__msg__ControllerInfo;
    is_plain =
      (
...
static size_t _ControllerInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_as2_msgs__msg__ControllerInfo(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, as2_msgs, msg, ControllerInfo)() {
