...
#include "as2_msgs/msg/detail/node_status__rosidl_typesupport_fastrtps_c.h"
...
using _NodeStatus__ros_msg_type = as2_msgs__msg__NodeStatus;
...
static uint32_t _NodeStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_as2_msgs__msg__NodeStatus(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = as2_msgs__msg__NodeStatus;
    is_plain =
      (
...
static size_t _NodeStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_as2_msgs__msg__NodeStatus(
