...
#include "as2_msgs/msg/detail/speed__rosidl_typesupport_fastrtps_c.h"
...
using _Speed__ros_msg_type = as2_msgs__msg__Speed;
...
static uint32_t _Speed__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_as2_msgs__msg__Speed(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = as2_msgs__msg__Speed;
    is_plain =
      (
...
static size_t _Speed__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_as2_msgs__msg__Speed(
