    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'as2_msgs.action.FollowPath_Goal')
            logger.debug(
...
class Metaclass_FollowPath_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'as2_msgs.action.FollowPath_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class FollowPath_Result(metaclass=Metaclass_FollowPath_Result):
    ...
    __slots__ = [
        '_follow_path_success',
    ]

    _fields_and_field_types = {
        'follow_path_success': 'boolean',
    }
    ...
    def __init__(self, **kwargs):
        assert all('_' + key in self.__slots__ for key in kwargs.keys()), \
            'Invalid arguments passed to constructor: %s' % \
            ', '.join(sorted(k for k in kwargs.keys() if '_' + k not in self.__slots__))
        self.follow_path_success = kwargs.get('follow_path_success', bool())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.follow_path_success != other.follow_path_success:
            return False
        return True
    ...
    @builtins.property
    def follow_path_success(self):
        """Message field 'follow_path_success'."""
        return self._follow_path_success

    @follow_path_success.setter
    def follow_path_success(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'follow_path_success' field must be of type 'bool'"
        self._follow_path_success = value
...
class Metaclass_FollowPath_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'as2_msgs.action.FollowPath_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class FollowPath_Feedback(metaclass=Metaclass_FollowPath_Feedback):
    ...
    __slots__ = [
        '_actual_speed',
        '_actual_distance_to_next_waypoint',
    ...
    _fields_and_field_types = {
        'actual_speed': 'float',
        'actual_distance_to_next_waypoint': 'float',
    ...
    def __init__(self, **kwargs):
        ...
        self.actual_distance_to_next_waypoint = kwargs.get('actual_distance_to_next_waypoint', float())
    ...
    def __eq__(self, other):
        ...
        if self.actual_speed != other.actual_speed:
            return False
        if self.actual_distance_to_next_waypoint != other.actual_distance_to_next_waypoint:
            return False
    ...
    @builtins.property
    def actual_distance_to_next_waypoint(self):
        """Message field 'actual_distance_to_next_waypoint'."""
        return self._actual_distance_to_next_waypoint

    @actual_distance_to_next_waypoint.setter
    def actual_distance_to_next_waypoint(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'actual_distance_to_next_waypoint' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'actual_distance_to_next_waypoint' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._actual_distance_to_next_waypoint = value
...
class FollowPath_SendGoal_Request(metaclass=Metaclass_FollowPath_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'as2_msgs/FollowPath_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['as2_msgs', 'action'], 'FollowPath_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from as2_msgs.action._follow_path import FollowPath_Goal
...
class Metaclass_FollowPath_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'as2_msgs.action.FollowPath_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from as2_msgs.action import _follow_path
...
class FollowPath_SendGoal(metaclass=Metaclass_FollowPath_SendGoal):
    from as2_msgs.action._follow_path import FollowPath_SendGoal_Request as Request
    from as2_msgs.action._follow_path import FollowPath_SendGoal_Response as Response
...
class FollowPath_GetResult_Response(metaclass=Metaclass_FollowPath_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'as2_msgs/FollowPath_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['as2_msgs', 'action'], 'FollowPath_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from as2_msgs.action._follow_path import FollowPath_Result
...
class Metaclass_FollowPath_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'as2_msgs.action.FollowPath_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class FollowPath_GetResult(metaclass=Metaclass_FollowPath_GetResult):
    from as2_msgs.action._follow_path import FollowPath_GetResult_Request as Request
    from as2_msgs.action._follow_path import FollowPath_GetResult_Response as Response
...
class Metaclass_FollowPath_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'as2_msgs.action.FollowPath_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class FollowPath_FeedbackMessage(metaclass=Metaclass_FollowPath_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'as2_msgs/FollowPath_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['as2_msgs', 'action'], 'FollowPath_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from as2_msgs.action._follow_path import FollowPath_Feedback
...
class FollowPath(metaclass=Metaclass_FollowPath):
    ...
    from as2_msgs.action._follow_path import FollowPath_Goal as Goal
    # The result message defined in the action definition.
    from as2_msgs.action._follow_path import FollowPath_Result as Result
    # The feedback message defined in the action definition.
    from as2_msgs.action._follow_path import FollowPath_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from as2_msgs.action._follow_path import FollowPath_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from as2_msgs.action._follow_path import FollowPath_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from as2_msgs.action._follow_path import FollowPath_FeedbackMessage as FeedbackMessage
