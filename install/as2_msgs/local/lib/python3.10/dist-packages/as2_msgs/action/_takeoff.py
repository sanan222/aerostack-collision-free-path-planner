...
class Takeoff_Goal(metaclass=Metaclass_Takeoff_Goal):
    ...
    def __init__(self, **kwargs):
        ...
        self.takeoff_height = kwargs.get('takeoff_height', float())
        self.takeoff_speed = kwargs.get('takeoff_speed', float())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.takeoff_height != other.takeoff_height:
            return False
        if self.takeoff_speed != other.takeoff_speed:
            return False
        return True
    ...
    def takeoff_height(self):
        """Message field 'takeoff_height'."""
        return self._takeoff_height

    @takeoff_height.setter
    def takeoff_height(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'takeoff_height' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'takeoff_height' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._takeoff_height = value

    @builtins.property
    def takeoff_speed(self):
        """Message field 'takeoff_speed'."""
        return self._takeoff_speed

    @takeoff_speed.setter
    def takeoff_speed(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'takeoff_speed' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'takeoff_speed' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._takeoff_speed = value
...
class Metaclass_Takeoff_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'as2_msgs.action.Takeoff_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Takeoff_Result(metaclass=Metaclass_Takeoff_Result):
    ...
    def __init__(self, **kwargs):
        assert all('_' + key in self.__slots__ for key in kwargs.keys()), \
            'Invalid arguments passed to constructor: %s' % \
            ', '.join(sorted(k for k in kwargs.keys() if '_' + k not in self.__slots__))
        self.takeoff_success = kwargs.get('takeoff_success', bool())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.takeoff_success != other.takeoff_success:
            return False
        return True
    ...
    @builtins.property
    def takeoff_success(self):
        """Message field 'takeoff_success'."""
        return self._takeoff_success

    @takeoff_success.setter
    def takeoff_success(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'takeoff_success' field must be of type 'bool'"
        self._takeoff_success = value
...
class Metaclass_Takeoff_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'as2_msgs.action.Takeoff_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Takeoff_Feedback(metaclass=Metaclass_Takeoff_Feedback):
    ...
    __slots__ = [
        '_actual_takeoff_speed',
        '_actual_takeoff_height',
    ]

    _fields_and_field_types = {
        'actual_takeoff_speed': 'float',
        'actual_takeoff_height': 'float',
    }
    ...
    def __init__(self, **kwargs):
        assert all('_' + key in self.__slots__ for key in kwargs.keys()), \
            'Invalid arguments passed to constructor: %s' % \
            ', '.join(sorted(k for k in kwargs.keys() if '_' + k not in self.__slots__))
        self.actual_takeoff_speed = kwargs.get('actual_takeoff_speed', float())
        self.actual_takeoff_height = kwargs.get('actual_takeoff_height', float())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.actual_takeoff_speed != other.actual_takeoff_speed:
            return False
        if self.actual_takeoff_height != other.actual_takeoff_height:
            return False
        return True
    ...
    @builtins.property
    def actual_takeoff_speed(self):
        """Message field 'actual_takeoff_speed'."""
        return self._actual_takeoff_speed

    @actual_takeoff_speed.setter
    def actual_takeoff_speed(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'actual_takeoff_speed' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'actual_takeoff_speed' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._actual_takeoff_speed = value

    @builtins.property
    def actual_takeoff_height(self):
        """Message field 'actual_takeoff_height'."""
        return self._actual_takeoff_height

    @actual_takeoff_height.setter
    def actual_takeoff_height(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'actual_takeoff_height' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'actual_takeoff_height' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._actual_takeoff_height = value
...
class Takeoff_SendGoal_Request(metaclass=Metaclass_Takeoff_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'as2_msgs/Takeoff_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['as2_msgs', 'action'], 'Takeoff_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from as2_msgs.action._takeoff import Takeoff_Goal
...
class Metaclass_Takeoff_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'as2_msgs.action.Takeoff_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from as2_msgs.action import _takeoff
...
class Takeoff_SendGoal(metaclass=Metaclass_Takeoff_SendGoal):
    from as2_msgs.action._takeoff import Takeoff_SendGoal_Request as Request
    from as2_msgs.action._takeoff import Takeoff_SendGoal_Response as Response
...
class Takeoff_GetResult_Response(metaclass=Metaclass_Takeoff_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'as2_msgs/Takeoff_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['as2_msgs', 'action'], 'Takeoff_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from as2_msgs.action._takeoff import Takeoff_Result
...
class Metaclass_Takeoff_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'as2_msgs.action.Takeoff_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Takeoff_GetResult(metaclass=Metaclass_Takeoff_GetResult):
    from as2_msgs.action._takeoff import Takeoff_GetResult_Request as Request
    from as2_msgs.action._takeoff import Takeoff_GetResult_Response as Response
...
class Metaclass_Takeoff_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'as2_msgs.action.Takeoff_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Takeoff_FeedbackMessage(metaclass=Metaclass_Takeoff_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'as2_msgs/Takeoff_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['as2_msgs', 'action'], 'Takeoff_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from as2_msgs.action._takeoff import Takeoff_Feedback
...
class Takeoff(metaclass=Metaclass_Takeoff):
    ...
    from as2_msgs.action._takeoff import Takeoff_Goal as Goal
    # The result message defined in the action definition.
    from as2_msgs.action._takeoff import Takeoff_Result as Result
    # The feedback message defined in the action definition.
    from as2_msgs.action._takeoff import Takeoff_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from as2_msgs.action._takeoff import Takeoff_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from as2_msgs.action._takeoff import Takeoff_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from as2_msgs.action._takeoff import Takeoff_FeedbackMessage as FeedbackMessage
