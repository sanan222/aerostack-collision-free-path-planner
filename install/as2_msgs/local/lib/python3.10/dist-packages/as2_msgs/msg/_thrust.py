...
class Thrust(metaclass=Metaclass_Thrust):
    ...
    def __init__(self, **kwargs):
        ...
        self.thrust_normalized = kwargs.get('thrust_normalized', float())
    ...
    def __eq__(self, other):
        ...
        if self.thrust != other.thrust:
            return False
        if self.thrust_normalized != other.thrust_normalized:
            return False
        return True
    ...
    @builtins.property
    def thrust_normalized(self):
        """Message field 'thrust_normalized'."""
        return self._thrust_normalized

    @thrust_normalized.setter
    def thrust_normalized(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'thrust_normalized' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'thrust_normalized' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._thrust_normalized = value
