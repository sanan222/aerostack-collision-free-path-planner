...
#ifndef AS2_MSGS__SRV__DETAIL__GET_ORIGIN__FUNCTIONS_H_
#define AS2_MSGS__SRV__DETAIL__GET_ORIGIN__FUNCTIONS_H_
...
/// Initialize srv/GetOrigin message.
/**
...
/// Finalize srv/GetOrigin message.
/**
...
/// Create srv/GetOrigin message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * as2_msgs__srv__GetOrigin_Request__init().
...
/// Destroy srv/GetOrigin message.
/**
 * It calls
 * as2_msgs__srv__GetOrigin_Request__fini()
...
/// Check for srv/GetOrigin message equality.
/**
...
/// Initialize array of srv/GetOrigin messages.
/**
...
/// Finalize array of srv/GetOrigin messages.
/**
 * It calls
 * as2_msgs__srv__GetOrigin_Request__fini()
...
/// Create array of srv/GetOrigin messages.
/**
 * It allocates the memory for the array and calls
 * as2_msgs__srv__GetOrigin_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/GetOrigin messages.
/**
 * It calls
 * as2_msgs__srv__GetOrigin_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/GetOrigin message array equality.
/**
...
/// Copy an array of srv/GetOrigin messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * as2_msgs__srv__GetOrigin_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_as2_msgs
...
/**
 * It calls
 * as2_msgs__srv__GetOrigin_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_as2_msgs
...
/**
 * It allocates the memory for the array and calls
 * as2_msgs__srv__GetOrigin_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_as2_msgs
...
/**
 * It calls
 * as2_msgs__srv__GetOrigin_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // AS2_MSGS__SRV__DETAIL__GET_ORIGIN__FUNCTIONS_H_
